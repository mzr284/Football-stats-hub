export default function NewsPage(){
    return(
        <div className="flex translate-y-25 flex-col gap-14 pt-15 px-15">
            <div className="flex gap-10 bg-blue-50 py-10 px-7 rounded border border-blue-400">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <p className="text-blue-950 text-[19px]">Paris Saint-Germain and France forward Ousmane Dembélé has won the 2025 Men's Ballon d'Or.
            ...
            <div className="flex gap-10 bg-blue-50 py-10 px-7 rounded border border-blue-400">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <p className="text-blue-950 text-[19px]">UEFA Technical Observer Rafa Benítez analyses how the likes of Vinícius Júnior,
            ...
            <div className="flex gap-10 bg-blue-50 py-10 px-7 rounded border border-blue-400">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <p className="text-blue-950 text-[19px]">Keep track of every UEFA Champions League Player of the Week in 2025/26
                       <br/>
                       <br/>
