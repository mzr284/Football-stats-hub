export default function TeamData({team}){
    console.log(team)
    return(
        <div className="flex lg:flex-col flex-wrap bg-gray-100 px-3 py-5 gap-3 w-60">
            ...
            <div className="flex flex-col lg:items-start items-center justify-center text-center">
